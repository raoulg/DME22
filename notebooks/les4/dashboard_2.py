...
def main() -> None:
    ...
    species_filter = st.multiselect("Select Species", options=st.session_state.penguins['Species'].unique())
    if species_filter:
        st.session_state.penguins = st.session_state.penguins[st.session_state.penguins['Species'].isin(species_filter)]
