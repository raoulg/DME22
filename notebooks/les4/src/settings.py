...
class _Settings(BaseModel):
    ...
    target: str = "species"
    knmi_uurgegevens_api_url: str = (
        r"https://www.daggegevens.knmi.nl/klimatologie/uurgegevens"
    )
    knmi_uurgegevens_date_col: str = "date"
    knmi_uurgegevens_hour_col: str = "hour"
    knmi_uurgegevens_raw_temp_col: str = "T"
    knmi_stations_file_url: str = (
        r"https://cdn.knmi.nl/knmi/map/page/klimatologie/gegevens/AWS_april2022_1d.txt"
    )
